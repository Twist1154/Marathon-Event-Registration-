...
import eureka.Connect;
import eureka.main.ex;
    ...
    public static void admin_menu() {
        ...
        create_but.addActionListener(new ActionListener() { //Perform action
            public void actionPerformed(ActionEvent e) {
               ...
               new create(); //Call create function
        ...
        JButton btnUsers = new JButton("View Users");//creating instance of JButton to view users
        btnUsers.setBounds(150, 20, 120, 25);//x axis, y axis, width, height 
        btnUsers.addActionListener(new ActionListener() { //Perform action on click button
            public void actionPerformed(ActionEvent e) {
        ...
        JButton btnIssuedBook = new JButton("View Issued Books");//creating instance of JButton to view the issued books
        ...
        JButton btnaddUser = new JButton("Add User"); //creating instance of JButton to add users
        btnaddUser.setBounds(20, 60, 120, 25); //set dimensions for button

        btnaddUser.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {

                JFrame EnterDetails = new JFrame("Enter User Details"); //Frame to enter user details
                ...
                EnterDetails.add(l1);
                EnterDetails.add(l2);
                EnterDetails.add(F_user);
                EnterDetails.add(F_pass);
                EnterDetails.setSize(350, 200);//400 width and 500 height  
                EnterDetails.setLayout(null);//using no layout managers  
                EnterDetails.setVisible(true);//making the frame visible 
                EnterDetails.setLocationRelativeTo(null);

            }
        });

        JButton btnAddBook = new JButton("Add Book"); //creating instance of JButton for adding books
        ...
        JButton btnIssuebook = new JButton("Issue Book"); //creating instance of JButton to issue books
        ...
        JButton btnReturnbook = new JButton("Return Book"); //creating instance of JButton to return books
        ...
        btnReturnbook.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                JButton btnCalCulateFine = new JButton("Return");//creating instance of JButton to mention return date and calculcate fine
                btnCalCulateFine.setBounds(130, 170, 80, 25);//x axis, y axis, width, height 
                btnCalCulateFine.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            ...
                            if (ex.days & amp;amp;amp;amp;amp;amp;amp;amp;amp;amp;gt;diff_int
